              ...
              <div className="grid md:grid-cols-2 gap-4">
                {userGroups.map(group => (
                  <div 
                    ...
                    className="border border-gray-200 rounded-lg p-4 hover:bg-indigo-50 hover:border-indigo-300 cursor-pointer transition"
                  >
                    <h3 className="font-medium text-indigo-700">{group.name}</h3>
                ...
                <div className="space-y-4">
                  {pendingExpenses.map(expense => {
                    ...
                    const splitAmount = expense.splitBetween?.length > 0
                      ...
                      console.log( isVerified, expense, "---")
                    return (
                      <div
                        key={expense._id}
                  ...
                  {verifiedExpenses.map(expense => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isSettled && (
                          <div className="mt-4 flex justify-end">
                            <span className="flex items-center text-sm bg-gray-100 text-gray-600 px-3 py-1 rounded-md">
